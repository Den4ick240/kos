...
function getState {
    ...
    local vf is gravityVec:normalized * 5.
...
until ship:status = "LANDED" {
    ...
    local offsetLandingSitePosition is landingSite:altitudeposition(landingSite:terrainheight + 40). // todo offset by ship height
